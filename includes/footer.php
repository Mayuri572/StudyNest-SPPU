<footer class="footer">
    <div class="container footer-grid">
        ...
        <div class="footer-col">
            ...
            <ul class="footer-links">
                <li><a href="/studynest/index.php">Home</a></li>
                <li><a href="/studynest/user/notes.php">Download Notes</a></li>
                <li><a href="/studynest/user/pyq.php">Previous Year Papers</a></li>
                <li><a href="/studynest/user/store.php">Book Store</a></li>
            </ul>
        </div>
        <div class="footer-col">
            <h4>Contact Info</h4>
            <ul class="footer-links">
                <li><i class="fa-solid fa-location-dot"></i> Pune, Maharashtra</li>
                <li><i class="fa-solid fa-envelope"></i> support@studynestsppu.com</li>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo date("Y"); ?> StudyNest SPPU. Designed for SPPU Students.</p>
    </div>
</footer>

<script src="/studynest/assets/js/script.js"></script>
</body>
</html>