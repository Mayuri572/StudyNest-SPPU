...
<header class="navbar">
    <div class="nav-container">
        <a href="/studynest/index.php" class="logo">
            <img src="/studynest/assets/images/logo.png" alt="StudyNest Logo" onerror="this.src='https://via.placeholder.com/40x40?text=Logo'">
        ...
        <div class="nav-icons">
            <div class="search-bar">
                <form action="/studynest/user/store.php" method="GET" style="display:flex; align-items:center;">
                    <input type="text" name="search" placeholder="Search books..." value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>">
                    <button type="submit" style="border:none; background:none; cursor:pointer;"><i class="fa-solid fa-magnifying-glass" style="color:var(--text-light);"></i></button>
                </form>
            </div>
